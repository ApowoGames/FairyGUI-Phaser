namespace fgui {
    ...
    export class Byte {
        ...
        _readMatrix(): Phaser.GameObjects.Components.TransformMatrix {
            var rst: Phaser.GameObjects.Components.TransformMatrix = new Phaser.GameObjects.Components.TransformMatrix(this.getFloat32(), this.getFloat32(), this.getFloat32(), this.getFloat32(), this.getFloat32(), this.getFloat32());
            return rst;
        }
