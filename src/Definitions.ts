namespace fgui {
        ...
        let hasTouch = 'ontouchstart' in window && Phaser.Game.;
        ...
        let easeMap: EaseTypeDictionary = {
            ...
            "Elastic.In": Phaser.Math.Easing.Elastic.In,
            "Elastic.Out": Phaser.Math.Easing.Elastic.Out,
            "Elastic.InOut": Phaser.Math.Easing.Elastic.InOut,
            "Quad.In": Phaser.Math.Easing.Quadratic.In,
            "Quad.Out": Phaser.Math.Easing.Quadratic.Out,
            "Quad.InOut": Phaser.Math.Easing.Quadratic.InOut,
            "Cube.In": Phaser.Math.Easing.Cubic.In,
            "Cube.Out": Phaser.Math.Easing.Cubic.Out,
            "Cube.InOut": Phaser.Math.Easing.Cubic.InOut,
            "Quart.In": Phaser.Math.Easing.Quartic.In,
            "Quart.Out": Phaser.Math.Easing.Quartic.Out,
            "Quart.InOut": Phaser.Math.Easing.Quartic.InOut,
            "Quint.In": Phaser.Math.Easing.Quintic.In,
            "Quint.Out": Phaser.Math.Easing.Quintic.Out,
            "Quint.InOut": Phaser.Math.Easing.Quintic.InOut,
            "Sine.In": Phaser.Math.Easing.Sine.In,
            "Sine.Out": Phaser.Math.Easing.Sine.Out,
            "Sine.InOut": Phaser.Math.Easing.Sine.InOut,
            "Bounce.In": Phaser.Math.Easing.Bounce.In,
            "Bounce.Out": Phaser.Math.Easing.Bounce.Out,
            "Bounce.InOut": Phaser.Math.Easing.Bounce.InOut,
            "Circ.In": Phaser.Math.Easing.Circular.In,
            "Circ.Out": Phaser.Math.Easing.Circular.Out,
            "Circ.InOut": Phaser.Math.Easing.Circular.InOut,
            "Expo.In": Phaser.Math.Easing.Expo.In,
            "Expo.Out": Phaser.Math.Easing.Expo.Out,
            "Expo.InOut": Phaser.Math.Easing.Expo.InOut,
            "Back.In": Phaser.Math.Easing.Back.In,
            "Back.Out": Phaser.Math.Easing.Back.Out,
            "Back.InOut": Phaser.Math.Easing.Back.InOut
        };
