...
declare module 'fgui' {
    export * from "fgui/GRoot";
    export * from "fgui/GObject";
    export * from "fgui/GComponent";
    export * from "fgui/Window";
    export * from "fgui/UIPackage";
    export * from "fgui/UIObjectFactory";
    export * from "fgui/UIConfig";
    export * from "fgui/TranslationHelper";
    export * from "fgui/Transition";
    export * from "fgui/ScrollPane";
    export * from "fgui/Relations";
    export * from "fgui/RelationItem";
    export * from "fgui/PopupMenu";
    export * from "fgui/PackageItem";
    export * from "fgui/Margin";
    export * from "fgui/IUISource";
    export * from "fgui/GTreeNode";
    export * from "fgui/GTree";
    export * from "fgui/GTextInput";
    export * from "fgui/GTextField";
    export * from "fgui/GSlider";
    export * from "fgui/GScrollBar";
    export * from "fgui/GRichTextField";
    export * from "fgui/GProgressBar";
    export * from "fgui/GObjectPool";
    export * from "fgui/GMovieClip";
    export * from "fgui/GLoader";
    export * from "fgui/GList";
    export * from "fgui/GLabel";
    export * from "fgui/GImage";
    export * from "fgui/GGroup";
    export * from "fgui/GGraph";
    export * from "fgui/GComboBox";
    export * from "fgui/GButton";
    export * from "fgui/GBasicTextField";
    export * from "fgui/FieldTypes";
    export * from "fgui/Events";
    export * from "fgui/DragDropManager";
    export * from "fgui/Controller";
    export * from "fgui/AsyncOperation";
    export * from "fgui/AssetProxy";
    export * from "fgui/action";
    export * from "fgui/display";
    export * from "fgui/event";
    export * from "fgui/gears";
    export * from "fgui/tween";
    export * from "fgui/utils";
}

declare module 'fgui/GRoot' {
    import { GObject } from 'fgui/GObject';
    import { UIStageOptions } from 'fgui/display/UIStage';
...
declare module 'fgui/GObject' {
    ...
    import { GComboBox } from 'fgui/GComboBox';
    import { GGraph } from 'fgui/GGraph';
    import { GSlider } from 'fgui/GSlider';
    import { GLabel } from 'fgui/GLabel';
    import { GButton } from 'fgui/GButton';
    import { GProgressBar } from 'fgui/GProgressBar';
    import { Controller } from 'fgui/Controller';
    import { GRichTextField } from 'fgui/GRichTextField';
    import { GTextInput } from 'fgui/GTextInput';
    import { GTextField } from 'fgui/GTextField';
    import { GMovieClip } from 'fgui/GMovieClip';
    import { GImage } from 'fgui/GImage';
...
declare module 'fgui/GComponent' {
    ...
    import { Controller } from 'fgui/Controller';
    import { Graphics } from 'fgui/display/Graphics';
    import { GObject } from 'fgui/GObject';
...
declare module 'fgui/Window' {
    import { GRoot } from 'fgui/GRoot';
    import { IUISource } from 'fgui/IUISource';
    import { GObject } from 'fgui/GObject';
    import "phaser";
    import { GComponent } from "fgui/GComponent";
...
declare module 'fgui/RelationItem' {
    import { GObject } from 'fgui/GObject';
...
declare module 'fgui/PackageItem' {
    import { BitmapFont } from 'fgui/display/BitmapFont';
    import { Frame } from 'fgui/display/MovieClip';
    import { PixelHitTestData } from 'fgui/utils/PixelHitTest';
    import { ByteBuffer } from 'fgui/utils/ByteBuffer';
...
declare module 'fgui/GBasicTextField' {
    import { GTextField } from 'fgui/GTextField';
...
declare module 'fgui/Events' {
    import { InteractiveEvent } from "fgui/event/DisplayObjectEvent";
    export class Events {
...
declare module 'fgui/AssetProxy' {
...
declare module 'fgui/action' {
    export * from "fgui/action/ChangePageAction";
    export * from "fgui/action/ControllerAction";
    export * from "fgui/action/PlayTransitionAction";
}

declare module 'fgui/display' {
    export * from "fgui/display/BitmapFont";
    export * from "fgui/display/FillUtils";
    export * from "fgui/display/Graphics";
    export * from "fgui/display/Image";
    export * from "fgui/display/MovieClip";
    export * from "fgui/display/UIStage";
}

declare module 'fgui/event' {
    export * from "fgui/event/DisplayObjectEvent";
    export * from "fgui/event/Event";
}

declare module 'fgui/gears' {
    export * from "fgui/gears/GearAnimation";
    export * from "fgui/gears/GearBase";
    export * from "fgui/gears/GearColor";
    export * from "fgui/gears/GearDisplay";
    export * from "fgui/gears/GearDisplay2";
    export * from "fgui/gears/GearFontSize";
    export * from "fgui/gears/GearIcon";
    export * from "fgui/gears/GearLook";
    export * from "fgui/gears/GearSize";
    export * from "fgui/gears/GearText";
    export * from "fgui/gears/GearXY";
}

declare module 'fgui/tween' {
    export * from "fgui/tween/EaseManager";
    export * from "fgui/tween/EaseType";
    export * from "fgui/tween/GPath";
    export * from "fgui/tween/GPathPoint";
    export * from "fgui/tween/GTween";
    export * from "fgui/tween/GTweener";
    export * from "fgui/tween/TweenManager";
    export * from "fgui/tween/TweenValue";
}

declare module 'fgui/utils' {
    export * from "fgui/utils/Byte";
    export * from "fgui/utils/ByteBuffer";
    export * from "fgui/utils/ChildHitArea";
    export * from "fgui/utils/ColorMatrix";
    export * from "fgui/utils/DOMEventManager";
    export * from "fgui/utils/HitArea";
    export * from "fgui/utils/PixelHitTest";
    export * from "fgui/utils/ToolSet";
    export * from "fgui/utils/UBBParser";
}

declare module 'fgui/display/UIStage' {
    import { UISceneDisplay } from "fgui/GRoot";
...
declare module 'fgui/display/Graphics' {
...
declare module 'fgui/display/BitmapFont' {
...
declare module 'fgui/utils/PixelHitTest' {
    import { Byte } from 'fgui/utils/Byte';
    import { HitArea } from 'fgui/utils/HitArea';
...
declare module 'fgui/event/DisplayObjectEvent' {
...
declare module 'fgui/action/ChangePageAction' {
    import { ByteBuffer } from 'fgui/utils/ByteBuffer';
    import { ControllerAction } from 'fgui/action/ControllerAction';
    import { Controller } from 'fgui/Controller';
...
declare module 'fgui/action/ControllerAction' {
    import { ByteBuffer } from 'fgui/utils/ByteBuffer';
    import { Controller } from 'fgui/Controller';
...
declare module 'fgui/action/PlayTransitionAction' {
    import { ByteBuffer } from 'fgui/utils/ByteBuffer';
    import { Controller } from 'fgui/Controller';
    import { ControllerAction } from 'fgui/action/ControllerAction';
...
declare module 'fgui/display/FillUtils' {
...
declare module 'fgui/tween/EaseManager' {
...
declare module 'fgui/tween/TweenManager' {
    import { GTweener } from 'fgui/tween/GTweener';
...
declare module 'fgui/utils/Byte' {
    /**
...
declare module 'fgui/utils/ChildHitArea' {
    import { HitArea } from 'fgui/utils/HitArea';
    import { GObject } from 'fgui/GObject';
...
declare module 'fgui/utils/ColorMatrix' {
...
declare module 'fgui/utils/DOMEventManager' {
...
declare module 'fgui/utils/HitArea' {
    import { Graphics } from "fgui/display/Graphics";
    /**
...
declare module 'fgui/utils/ToolSet' {
    import { GObject } from 'fgui/GObject';
